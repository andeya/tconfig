...
// Usage:
// import(
//   _ "github.com/henrylee2cn/tconfig/xml"
//   "github.com/henrylee2cn/tconfig"
// )
//
//  cnf, err := tconfig.NewConfig("xml", "tconfig.xml")
//
...
// ParseData xml data
func (xc *Config) ParseData(data []byte) (tconfig.Configer, error) {
