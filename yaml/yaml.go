...
//
//  more docs http://beego.me/docs/module/tconfig.md
package yaml
...
import (
	...
	"github.com/henrylee2cn/tconfig/yaml/goyaml2"
...
func (yaml *Config) Parse(filename string) (y tconfig.Configer, err error) {
...
func (yaml *Config) ParseData(data []byte) (tconfig.Configer, error) {
