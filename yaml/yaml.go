...
// package yaml for tconfig provider

//
// Usage:
// import(
//   _ "github.com/henrylee2cn/tconfig/yaml"
//   "github.com/henrylee2cn/tconfig"
// )
//
//  cnf, err := tconfig.NewConfig("yaml", "tconfig.yaml")
...
// YAMLConfig is a yaml tconfig parser and implements Config interface.
type YAMLConfig struct{}

// Parse returns a ConfigContainer with parsed yaml tconfig map.
func (yaml *YAMLConfig) Parse(filename string) (y tconfig.ConfigContainer, err error) {
...
func (yaml *YAMLConfig) ParseData(data []byte) (tconfig.ConfigContainer, error) {
...
// A Config represents the yaml tconfiguration.
...
// SaveConfigFile save the tconfig into file
func (c *YAMLConfigContainer) SaveConfigFile(filename string) (err error) {
	// Write tconfiguration file by filename.
...
func init() {
	tconfig.Register("yaml", &YAMLConfig{})
}
